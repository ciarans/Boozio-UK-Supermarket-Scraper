 ...
 * 
 * Class for Scrapping the Supermarket Ocado
 * 
 */
...
class Ocado extends Supermarket {

    public function __construct() {
        $this->url = "https://www.ocado.com/webshop/getBackOfPackPopup.do?sku=";
        $this->supermarket_name = "Ocado";
    }
